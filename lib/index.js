...
if (require.main === module) {
  ...
  const optionDefinitions = [
    { name: 'number', alias: 'n', type: Number, defaulOption: 4 },
    {
      name: 'coordinate',
      alias: 'c',
      type: Array,
    ...
    { name: 'r', type: Number, defaulOption: 10 },
    { name: 't', type: Number, defaulOption: 300 },
    { name: 'center', type: Number, defaulOption: 0 },
